...
# reading file
tugasKu = pd.read_csv('day2.csv')
dataAsal = pd.read_csv('day.csv')
...
with tab1:
    ...
    st.markdown('**Original Data** sebelum diolah semua berbentuk numeric , sulit untuk dipahami tanpa ada numenklatur sebagai keterangan pendukung')
    st.write(dataAsal)
